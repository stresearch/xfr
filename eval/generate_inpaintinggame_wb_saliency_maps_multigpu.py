...
from xfr.inpainting_game.generate_whitebox_saliency import generate_wb_smaps
import torch
    ...
    try:
        ...
        if params['file'] is None:
            params['file'] = os.path.join(
                xfr.__path__[0],
                'inpainting_game/generate_whitebox_saliency.py'
            )
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--method', nargs='*',
        default=['meanEBP', 'contrastive', 'weighted-subtree'],
        type=str,
        help='restrict processing to specific subjects',
    )
