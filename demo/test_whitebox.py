...
def layerwise_ebp():
    ...
    wb = Whitebox(WhiteboxSTResnet(stresnet101('../models/resnet101_l2_d512_twocrop.pth')), ebp_version=5, ebp_subtree_mode='all')
...
def weighted_subtree_triplet_ebp(topk=1, mask='nose'):
    ...
    wbnet = WhiteboxSTResnet(stresnet101('../models/resnet101_l2_d512_twocrop.pth'))
